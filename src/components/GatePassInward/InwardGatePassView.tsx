...
import InwardGatePassBasicInfo from "./InwardGatePassBasicInfo";
import InwardMaterialInfo from "./InwardMaterialInfo";
;
 
import { Approver, Material } from "@/utils/types";
import { useLocation } from "react-router-dom";
import { toast } from "react-toastify";
import FormActionPrintPreview from "../GatePass/FormActionPrintPreview";
import InwardApprovalSectionDisplay from "./InwardApprovalSectionDisplay";
import InwardPhotoDocumentationForApproval from "./InwardPhotoDocumentationForApproval";
 
const InwardGatePassView: React.FC = () => {
...
const { inward_id } = useParams();
    ...
    return (
        <div className="h-screen flex flex-col bg-gray-50 text-gray-800 text-sm overflow-hidden">
            ...
            {/* <GatePassHeader title="Inward Gate Pass" subtitle="Materials Entering Premises " /> */}
            <GatePassHeader
                title="Inward Gate Pass"
                subtitle={`Materials Entering Premises (ID: ${inward_id})`}
            />
...
export default InwardGatePassView;