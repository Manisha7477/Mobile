...
const InwardPhotoDocumentationForApproval: React.FC<PhotoDocumentationProps> = ({
  onPhotosChange,
  initialPhotos
}) => {
  ...
  return (
    <section className="mb-3">
      ...
      <div className="flex flex-nowrap overflow-x-auto gap-3 pb-2 hide-scrollbar">
        {labels.map((label, i) => (
          <div key={i} className="border p-3 rounded-md bg-white shadow-sm min-w-[300px] flex-shrink-0">
...
export default InwardPhotoDocumentationForApproval;
//Photo Documenattion 
