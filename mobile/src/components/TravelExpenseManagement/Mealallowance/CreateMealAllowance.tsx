...
interface MealAllowanceFormProps {
  onClose?: () => void
}
 
const CreateMealAllowance: React.FC<MealAllowanceFormProps> = ({ onClose }) => {
  ...
  const calculateTotal = () => {
    return entries.reduce(
      (sum, entry) => sum + (Number(entry.mealAllowance) || 0),
      0,
    )
  }
...
export default CreateMealAllowance;